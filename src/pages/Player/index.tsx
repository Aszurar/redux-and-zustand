    ...
    <div className="h-screen bg-zinc-950 text-zinc-50 flex justify-center items-center">
      <div className="flex w-[1100px] flex-col gap-6">
        ...
        <header className="flex items-center justify-between">
          ...
          <button className={`flex items-center bg-violet-500 gap-2 px-3 py-2 
          rounded text-sm font-medium text-white transition-all duration-300
          hover:bg-violet-600 
          `}>
      ...
      <main className={`relative flex overflow-hidden rounded-lg border 
